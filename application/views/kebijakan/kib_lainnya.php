	...
	function openWindow($cek){
		...
		if(kib=='02'){
		var trkib	= 'trkib_b';	
		var url	  	= "<?php echo site_url(); ?>/laporan_kebijakan/kibb_lainnya";
		}else if(kib=='03'){
		var trkib	= 'trkib_c';	
		var url	  	= "<?php echo site_url(); ?>/laporan_kebijakan/kibc_lainnya";
		}else if(kib=='04'){
		var trkib	= 'trkib_d';	
		var url	  	= "<?php echo site_url(); ?>/laporan_kebijakan/kibd_lainnya";
		}else{
		var trkib	= 'trkib_e';	
		var url	  	= "<?php echo site_url(); ?>/laporan_kebijakan/kibe_lainnya";
		}
		
	/* 	if(cza=='1'){
		var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/kib_lainnya";
		}else{
		if(tgl_reg==''){
            alert('Belum Pilih KIB PER TANGGAL');
			exit();
        }
		var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/kibb_bulanan";
		} */
        if(cskpd==''){
        ...
        lc = '?kd_skpd='+cskpd+'&tahun_ini='+tahun_ini+'&ctahun='+ctahun+'&nm_skpd='+cnmskpd+'&tahu='+ctahu+'&per1='+ctgl_per1+'&per2='+ctgl_per2+'&tgl='+ctgl+'&tgl_reg='+tgl_reg+'&trkib='+trkib+'&za='+cza+'&pnilai='+pnilai+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>CETAK DAFTAR PENYUSUTAN ASET LAINNYA</b></h3>
    <fieldset>
