<script type="text/javascript">
	...
	function openWindow($cek){
		...
		//var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/rekap_kib_penyusutan_skpd";
		if(cza=='1'){
		var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/rekap_kib_penyusutan_skpd";
		}else{
		if(tgl_reg==''){
		...
		var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/rekap_kib_penyusutan_skpd_bln";
		}
...
<div id="content1"> 
    <h3 align="center"><b>CETAK REKAP PENYUSUTAN ASET TETAP ALL SKPD</b></h3>
    <fieldset>
