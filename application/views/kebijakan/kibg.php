	...
	function openWindow($cek){
		...
		if(cza=='1'){
			alert('MAAF,ASET TETAP TAK BERWUJUD DISUSUT BERDASARKAN BULANAN.!');
			exit();
		//var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/kibe";
		}else{
		if(tgl_reg==''){
            alert('Belum Pilih KIB PER TANGGAL');
			exit();
        }
		var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/kibg_bulanan";
		}
        if(cskpd==''){
...
<div id="content1"> 
    <h3 align="center"><b>CETAK DAFTAR PENYUSUTAN ASET TETAP KIB G<br>
    ASET TAK BERWUJUD</b></h3>
    <fieldset>
