<script type="text/javascript">
	...
	function openWindow($cek){
		...
		var url	  		= "<?php echo site_url(); ?>/laporan_kebijakan/rekap_kib_penyusutan_all_bln";
		}
		if(kib=='02'){
		var trkib	= 'trkib_b';	
		}else if(kib=='03'){
        ...
        lc = '?tahun_ini='+tahun_ini+'&kib='+kib+'&nmkib='+nmkib+'&tgl='+ctgl+'&tgl_akhir='+ctgl_akhir+'&ctahun='+ctahun+'&trkib='+trkib+'&tgl_reg='+tgl_reg+'&za='+cza+'&fa='+cpilih;
