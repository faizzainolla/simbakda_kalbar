    ...
    var no_urut=0; 
     ...
     $(function(){
	  ...
	  kd_kegiatan = rowData.kd_kegiatan;
			...
			get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kdgol,bidang,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent);
           //lutji(); 
...
$('#metode').combogrid({  
        ...
        onDblClickRow:function(rowIndex,rowData){
          ...
          bidang        = rowData.kd_bidang;
		   kd_kegiatan = rowData.kd_kegiatan;
			...
			kd_rek5 = rowData.kd_rek5;
			nm_rek5 = rowData.nm_rek5;
          get1(id_barang,noreg,no,tglreg,tgl_oleh,nodok,kdbrg,detail_brg,nilai,nilai_baru,jumlah,judul,spesifikasi,asal,cipta,tahun_terbit,penerbit,kd_bahan,jenis,tipe,kd_satuan,kondisi,ket,no_oleh,peroleh,dsr_peroleh,kd_skpd,kd_unit,milik,wilayah,tahun,foto,foto2,foto3,metode,masa_manfaat,nilai_sisa,lat,lon,kdgol,bidang,nmbrg,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5);
  ...
  function cek_status(no_dokumen){
    ...
    $.ajax({
      ...
      url :"<?php echo base_url(); ?>/index.php/transaksi/brg_aset_dh",
      dataType:"json",
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kdgol,bidang,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent){
    ...
    function get1(id_barang,noreg,no,tglreg,tgl_oleh,nodok,kdbrg,detail_brg,nilai,nilai_baru,jumlah,judul,spesifikasi,asal,cipta,tahun_terbit,penerbit,kd_bahan,jenis,tipe,kd_satuan,kondisi,ket,no_oleh,peroleh,dsr_peroleh,kd_skpd,kd_unit,milik,wilayah,tahun,foto,foto2,foto3,metode,masa_manfaat,nilai_sisa,lat,lon,kdgol,bidang,nmbrg,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5){ //get1(id_barang,noreg,no,tglreg,tgl_oleh,nodok,kdbrg,detail_brg,nilai,nilai_baru,jumlah,judul,spesifikasi,asal,cipta,tahun_terbit,penerbit,kd_bahan,jenis,tipe,kd_satuan,kondisi,ket,no_oleh,peroleh,dsr_peroleh,kd_unit,milik,wilayah,tahun,foto,foto2,foto3,metode,masa_manfaat,nilai_sisa,lat,lon){
  ...
  lcinsert = "(no_reg,id_barang,no,no_oleh,tgl_reg,tgl_peroleh,no_dokumen,kd_golongan,kd_bidang,kd_brg,nm_brg,detail_brg,nilai,peroleh,dsr_peroleh,jumlah,total,judul,spesifikasi,asal,cipta,tahun_terbit,penerbit,kd_bahan,jenis,tipe,kd_satuan,kondisi,keterangan,kd_skpd,kd_unit,milik,wilayah,username,tgl_update,tahun,no_urut,metode,masa_manfaat,nilai_sisa,kd_pemilik,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5)";
              
       	if (kd_brg==''){
            alert('Kode Barang Tidak Boleh Kosong.!');
            exit();
        }if (invent==1){
            alert('Tranaksi Sudah di Invent kan');
            exit();
        }if (tgl_reg==''){
        ...
        for(var i=0;i<jml;i++){
           ...
           nomor  = no_urt.substr(3,4);
            ...
            if(i>0){
	//			lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+file_gbr3+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+lat+"','"+lon+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
				lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
			}else{
//				lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+file_gbr3+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+lat+"','"+lon+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
				lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
			}              
		...
		//alert(lcvalues);
            $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trkib_e',urut:urutan,reg:no_urt,unit:kd_unit,no:no_dokumen,kolom:lcinsert,lcvalues:lcvalues,kdbrg:kd_brg}),
                    dataType:"json",
                    success:function(data){                                          
                        $.each(data,function(i,n){                                    
                            pesan = n['pesan'];
            ...
            //alert("update");
			 lcquery = "UPDATE trkib_e SET no_oleh='"+no_oleh+"',tgl_reg='"+tgl_reg+"',tgl_peroleh='"+tgl_oleh+"',no_dokumen='"+no_dokumen+"',kd_brg='"+kd_brg+"',nm_brg='"+nmbrg+"',detail_brg='"+detail+"',nilai='"+nilaisat+"',peroleh='"+perolehan+"',dsr_peroleh='"+dsr_peroleh+"',jumlah='"+jum+"',total='"+nilai_baru+"',judul='"+judul+"',spesifikasi='"+spesifikasi+"',asal='"+asal+"',cipta='"+pencipta+"',tahun_terbit='"+thn_terbit+"',penerbit='"+penerbit+"',kd_bahan='"+bahan+"',jenis='"+jenis+"',tipe='"+tipe+"',kd_satuan='"+satuan+"',kondisi='"+kondisi+"',keterangan='"+keterangan+"',kd_skpd='"+kd_skpd+"',kd_unit='"+kd_unit+"',milik='"+milik+"',wilayah='"+wilayah+"',username='"+user+"',tgl_update='<?php echo date('y-m-dH:i:s');?>',tahun='"+tahun+"',foto='"+file_gbr1+"',foto2='"+file_gbr2+"',foto3='"+file_gbr3+"',metode='"+metode+"',masa_manfaat='"+masa_manfaat+"',nilai_sisa='"+nilai_sisa+"',lat='"+lat+"',lon='"+lon+"',kd_pemilik='"+milik+"' where id_barang ='"+id_brg+"'";// and no_urut='"+urutan+"'
 ...
 function nomer_akhir(){
        ...
        var reg 	='no_reg'
        var kd_unit	= lcskpd;
        var brg= document.getElementById('kdbrg').value; 
        $.ajax({
            type: "POST",
...
function angkadanhuruf(e, goods, field){
 ...
 function isNumberKey(evt)
	...
	function kib_kib(cek){
		...
		if(link==2){kib = "inventaris_b";}else
		if(link==3){kib = "inventaris_c";}else
		if(link==4){kib = "inventaris_d";}else
...
<div align="center">
    ...
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING INVENTARIS ASET TETAP LAINNYA" style="width:900px;height:310px;" >  
        </table>
		<table align="center" border="0" style="width:900px;height:35px; border-radius:5px 5px 5px 5px; background-color:#D0D0D0;">  
			<tr>
				...
				&nbsp;<a class="easyui-linkbutton" plain="true" onclick="javascript:kib_kib(4);"><b>[4] Jalan, Irigasi Dan Jaringan</b></a> | 
            ...
            <tr>
              ...
              <td><input id="bida" name="bida"  disabled="true"/>  </td>                            
                       ...
                       <tr hidden="true">
                            <td>Ruangan</td>
                            <td>:</td>
                            <td><input name="ruang" type="text" id="ruang" style="width:250px;"/></td>
                       </tr>
                       <tr>
					 ...
					 <tr hidden="true">
                      ...
                      <tr hidden="true">
                       ...
                       <tr>
							<td colspan="3" hidden align="center" >
               ...
               <td width="50%" valign="top">
                    <table  align="left" style="width:100%;" border="0">
                       ...
                       <tr>
                            <td>Tahun Terbit </td>
                            <td>:</td>
                            <td><input type="text" id="thn_terbit" name="thn_terbit" style="width:150px;" onkeypress="return isNumberKey(event)"/></td>
                       </tr>
                       <tr>
                         <td>Satuan</td>
                         <td>&nbsp;</td>
