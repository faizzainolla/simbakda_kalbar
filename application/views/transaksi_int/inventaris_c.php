     ...
     $(function(){
      ...
      $('#nodok').combogrid({  
       ...
       onSelect:function(rowIndex,rowData){
            ...
            get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,jns_barang,kd_bidang,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent);
          // lutji();
...
/*	$('#bida').combogrid({  
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,jns_barang,kd_bidang,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent){
    ...
    function simpan(){
        ...
        for(var i=0;i<jml;i++){
			...
			//	lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kdgol+"','"+bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilai+"','"+peroleh+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+luas_gedung+"','"+jns_bangunan+"','"+luas_tanah+"','"+st_tanah+"','"+alamat1+"','"+alamat2+"','"+alamat3+"','"+kontruksi+"','"+kontruksi2+"','"+luas_lantai+"','"+kondisi+"','"+dasar_pengguna+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+kd_tanah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+file_gbr3+"','"+file_gbr4+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+clat+"','"+clon+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
				lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kdgol+"','"+bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilai+"','"+peroleh+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+luas_gedung+"','"+jns_bangunan+"','"+luas_tanah+"','"+st_tanah+"','"+alamat1+"','"+alamat2+"','"+alamat3+"','"+kontruksi+"','"+kontruksi2+"','"+luas_lantai+"','"+kondisi+"','"+dasar_pengguna+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+kd_tanah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
			}else{
          ...
          no_urut=no_urt;      
            ...
            $(document).ready(function(){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>index.php/transaksi/simpan_trkib_c_2',
...
<div align="center">
    ...
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING INVENTARIS GEDUNG BANGUNAN" style="width:900px;height:310px;" >  
        </table>
        </td>
        </tr>
    </table>    
