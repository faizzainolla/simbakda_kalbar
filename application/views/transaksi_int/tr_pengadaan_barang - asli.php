...
$(function(){ 
    $('#trh').edatagrid({
        ...
        columns:[[
			...
			{field:'nilai_kontrak2',title:'Nilai Kontrak',width:50,align:'right'},
	...
	function get_nomor_bap(lpnodok1){
		...
		$('#kontrak_bap').combogrid({  
            ...
            mode:'remote',
            url:'<?php echo base_url(); ?>index.php/master/nomor_kontrak_bap/?kode='+kode,  
            columns:[[  
...
$('#cmbjenis_u').combogrid({           
   ...
   $('#nomor').combogrid({  
            ...
            columns:[[  
				...
				{field:'nilai2',title:'Nilai Kontrak',width:110,align:'right'}, 
				{field:'nilai_bel2',title:'Nilai Transaksi',width:110,align:'right'}, 				
            ...
            onSelect:function(rowIndex,rowData){
                ...
                if (plonline =='1')
                {
                    ...
                    // $('#compy').combobox({url:'<?php echo base_url(); ?>index.php/master/ambil_compy/'+cpimp,
                    // queryParams:({q:cpimp})});      					
                }								
...
function loadDetail(){
    var nomor = $('#nomor').combogrid('getValue');
     $(function(){
            $('#trd').edatagrid({
                url: '<?php echo base_url(); ?>/index.php/transaksi/trd_rencana_isianbrg',
                queryParams:({ no:nomor }),
                 idField:'idx',
                 toolbar:"#toolbar",              
                 rownumbers:"true", 
...
function hapus(){
    ...
    if(del==true){
        var urll = '<?php echo base_url(); ?>index.php/transaksi/hapus_rencana_isianbrg';
        $(document).ready(function(){
...
function simpan(){
	...
	/*		
    if(sel<0){
        sweetAlert("MAAF...!!","Total Transaksi Tidak Boleh Melebihi Nilai Kontrak "+nkon2_view);
        $('#trd').datagrid('unselectAll');
        exit();
    }
	    if(sel>0){
        sweetAlert("MAAF...!!","Total Transaksi Tidak Boleh Kurang dari Nilai Kontrak "+nkon2_view);
        $('#trd').datagrid('unselectAll');
        exit();
    }*/
    if (no==''){
    ...
    $(document).ready(function(){
        $.ajax({
            type: "POST",       
            dataType : 'json',         
            data: ({tabel:'trh_treatbrg',no:no,tgl:tgl,nilkon:nilkon,nilapbd:nilapbd,kdcomp:kdcomp,kd_unit:kduskpd,kdmilik:kdmilik,kdwilayah:kdwilayah,mlokasi:mlokasi,jnsdana:jnsdana,tahunang:tahunang,buktibyr:buktibyr,dasaroleh:dasaroleh,nooleh:nooleh,tgloleh:tgloleh,tahunoleh:tahunoleh,tot:tot,cr_oleh:cr_oleh,csql_sisa:csql_sisa}),
            url: '<?php echo base_url(); ?>index.php/transaksi/simpan_rencana_isianbrg',
            success:function(data){
                simpan_detail_dh();
    ...
    var rows = $('#trd').datagrid('getSelections');
        ...
        for(var i=0; i<rows.length; i++){
                ...
                $.ajax({
                    ...
                    dataType:'json', 
                    url: '<?php echo base_url(); ?>/index.php/transaksi/simpan_rencana_isianbrg',   
                    data: ({tabel:'trd_treatbrg',no:no,sql:csql,kd_unit:kduskpd,kdcomp:kd_comp}),
...
function cetak(){
    ...
    $(function(){ 
     $('#trh').edatagrid({
        url: '<?php echo base_url(); ?>/index.php/transaksi/trh_rencana_isianbrg',
...
<div id="tabs" class="easyui-tabs">
		<p><h3 align="center">RENCANA PENGADAAN BARANG</h3></p>
    ...
    <div id="tabs-2">  
        ...
        <table align="center" border="0">
            <tr>
                <td >No. Dokumen</td>
                <td>:</td>
                <td><input type="text" id="nomor" name="nomor" style="width: 140px;" /><input type="hidden" id="sp2d" name="sp2d" style="width: 140px;" /></td>
                <td width="50px"></td>
                <td >Jenis Dana</td>
                <td>:</td>
                <td><input type="text" disabled id="dana" style="width: 140px;" /></td>                
            </tr>
            <tr>       
            ...
            <tr>
                ...
                <td>:</td>
                <td><input type="text" disabled id="bukti" style="width: 140px;" /></td> 
            </tr>
            <tr>
                <td>Nilai APBD</td> 
                <td>:</td>
                ...
                <td>:</td>
                <td><input type="text" disabled id="perolehan" style="width: 140px;" /></td>
                                               
            </tr>       
            <tr>
                <td>Perusahaan/Rekanan</td>
                <td>:</td>
                <td><input id="compy" disabled name="compy" style="width: 140px;" value="" />  </td>
                <td></td>
                <td >Dasar Perolehan</td>
                <td>:</td>
                <td><input type="text" disabled id="dasar" style="width: 140px;" /></td>  
            ...
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;a.Nomor</td>
                <td>:</td>
                <td><input type="text" disabled id="dsno" style="width: 140px;" /></td>    
                
            </tr>
            <tr>
                <td>Kepemilikan</td>
                <td>:</td>
                <td><input id="milik" disabled name="milik" style="width: 140px;" value=""/></td>
                <td></td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;b.Tanggal</td>
                <td>:</td>
                <td><input type="text" disabled id="dstgl" style="width: 140px;" /></td>
                
            </tr>                
            <tr>
                <td>Wilayah</td>
                <td>:</td>
                <td><input id="wilayah" disabled name="wilayah" style="width: 140px;" value=""/></td>
                <td></td>
            ...
            <tr>
                <td >*Keterangan</td>
                <td colspan="6">Nilai Kontrak &nbsp;&nbsp;:&nbsp;&nbsp;<input id="nkon" name="nkon" style="width: 140px;text-align: right;" disabled="true"><input type="hidden" id="nkon_hide" name="nkon_hide" style="width: 140px;text-align: right;" disabled="true">&nbsp;&nbsp;
    ...
    <fieldset title="Bukti / SP2D">
        <table>
            ...
            <tr>
                <td>Kegiatan</td>
                <td>:</td>
                <td><input type="text" id="kegiatan" disabled name="kegiatan" style="width: 200px;" readonly="true"/></td>
                <td><input type="text" id="nm_kegiatan" name="nm_kegiatan" style="width: 400px;border:0;" readonly="true"/></td>
            </tr>
            <tr>
                <td>Rekening</td>
                <td>:</td>
                <td><input type="text" id="rekening" disabled name="rekening" style="width: 200px;" readonly="true"/></td>
                <td><input type="text" id="nm_rekening" name="nm_rekening" style="width: 400px;border:0;" readonly="true"/></td>
            </tr>
			<tr>
                <td>Nilai Kontrak</td>
                <td>:</td>
                <td><input type="text" id="nilkon1" disabled name="nilkon1" style="width: 140px;text-align:right;" readonly="true"/><input type="hidden" id="nilkon1_hide" name="nilkon1_hide" style="width: 140px;text-align:right;" readonly="true"/></td>
