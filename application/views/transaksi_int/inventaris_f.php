...
<script type="text/javascript">
     ...
     $(function(){
      ...
      $('#nodok').combogrid({  
       ...
       onSelect:function(rowIndex,rowData){
           ...
           get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent);
           //lutji();   
		}  
     });
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent){
...
//		imageUrl:"<?php echo base_url();?>/lib/images/biak.jpg"
     ...
     function hapus(){      
      ...
      id_brg = rows.id_barang;
        ...
        $(document).ready(function(){
         $.post(urll,({no:id_brg,dok:nodok,no_urut:no_furut}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
...
function angkadanhuruf(e, goods, field){
 ...
 function isNumberKey(evt)
  ...
  function kib_kib(cek){
		...
		if(link==5){kib = "inventaris_e";}else
...
<div id="content1"> 
<div><h3 align="center"><b>.:INPUTAN INVENTARIS KONTRUKSI DALAM PEKERJAAN:.</b></h3></div>
<div align="center">
    <p>     
...
<div id="dialog-modal" title="">
    <p class="validateTips">.:Inventarisasi Kontruksi Dalam Pekerjaan</p> 
    <fieldset>
