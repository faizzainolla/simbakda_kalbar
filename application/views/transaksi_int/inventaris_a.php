...
<script type="text/javascript">
	...
	$('#nodok').combogrid({  
       ...
       onSelect:function(rowIndex,rowData){
           ...
           get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_bidang,jns_barang,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent);
  ...
  function cek_status(no_dokumen){
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_bidang,jns_barang,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,invent){
...
function angkadanhuruf(e, goods, field){
 ...
 function isNumberKey(evt)
	...
	function kib_kib(cek){
		...
		if(link==1){kib = "inventaris_b";}else
...
<div><h3 align="center"><b>.:INPUTAN INVENTARIS TANAH:.</b></h3></div>
    ...
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING INVENTARIS TANAH" style="width:900px;height:310px;">  
        </table>
               ...
               <td width="50%" valign="top">
                    <table align="left" style="width:100%;" border="0">
                       ...
                       <tr>
                            <td>No Dokumen</td>
                            <td>:</td>
                            <td><input type="text" id="nodok" name="nodok" style="width: 250px;" /><input id="inventt" name="inventt" style="width:250px; border:none;" hidden="true" /></td>
                       </tr>
						<tr>
						...
						<tr>
							<td>Bidang Barang</td>
							<td>:</td>
							<td><input id="bida" name="bida" type="text" disabled="true"/>  </td>                            
						</tr> 
                       <tr>
                            <td>Kode Barang </td>
                            <td>:</td>
