...
<script type="text/javascript">
     ...
     $(function(){
      ...
      $('#nosdok').combogrid({  
       ...
       onSelect:function(rowIndex,rowData){
           ...
           get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5);
           lutji();   
		}  
     });
	...
	function lutji(){
		...
		if(doku== ''){
		 $('#kdbrg').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/brg_kont2' }); 
		 }else{
		 $('#kdbrg').combogrid({url:'<?php echo base_url(); ?>index.php/transaksi/brg_kont',queryParams:({nodok:doku}) });     
		}
	} 
     $('#kdbrg').combogrid({  
           panelWidth:500,   
		   ...
		   url:'<?php echo base_url(); ?>index.php/transaksi/brg_kont2',           
           columns:[[
           ...
           onSelect:function(rowIndex,rowData){
			   ...
			   $("#detail_brg").attr("value",rowData.nm_brg);
	...
	$('#skpdasal').combogrid({  
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_f_mutasi_masuk',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
          ...
          kd_unit		= rowData.kd_unit;
		  milik			= rowData.milik;	
		  wilayah		= rowData.wilayah; //alert(milik+"-"+wilayah);
		  tahun			= rowData.tahun;
          foto			= rowData.foto;
          cokot(foto,'1');
          foto2			= rowData.foto2;
		  ...
		  kd_kegiatan = rowData.kd_kegiatan;
			...
			kd_rek5 = rowData.kd_rek5;
			nm_rek5 = rowData.nm_rek5;
          get1(id_barang,noreg,no,no_oleh,tgl_reg,nodok,kdbrg,detail_brg,kd_tnh,kondi,kontr,jenis,bangunan,ls,tgl_awal,sta_thn,nilai_kontrak,ket,alamat1,alamat2,alamat3,milik,wilayah,kd_skpd,asal,tahun,nilai,nilai_baru,jumlah,tgl_oleh,dsr_peroleh,kd_unit,foto,foto2,lat,lon,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5);
          edit_data();  
        }
    ...
    function  get1(id_barang,noreg,no,no_oleh,tgl_reg,nodok,kdbrg,detail_brg,kd_tnh,kondi,kontr,jenis,bangunan,ls,tgl_awal,sta_thn,nilai_kontrak,ket,alamat1,alamat2,alamat3,milik,wilayah,kd_skpd,asal,tahun,nilai,nilai_baru,jumlah,tgl_oleh,dsr_peroleh,kd_unit,foto,foto2,lat,lon,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5){
    ...
    function get(no_dokumen,kd_brg,kd_unit,kd_uskpd,nm_brg,jumlah,harga,total,keterangan,s_dana,kd_milik,kd_wilayah,b_dasar,b_nomor,tahun,b_tanggal,kd_cr_oleh,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5){
...
//	  		 var skpd  = '<?php echo ($this->session->userdata('unit_skpd')); ?>';
   ...
   function cari(){
    ...
    function simpan(){
		...
		if (tgl_awal==''){
            alert('tangal awal kerja Tidak Boleh Kosong..!!');
           exit();
        }
        ...
        for(var i=0;i<jml;i++){
           ...
           $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trkib_f',urut:urutan,reg:no_urt,unit:kd_unit,no:no_dokumen,kolom:lcinsert,lcvalues:lcvalues,kd_brg:kd_brg}),
                    dataType:"json"
                });
            });
        } else { 
             lcquery = "UPDATE trkib_f SET no_oleh='"+no_oleh+"',tgl_reg='"+tgl_reg+"',tgl_oleh='"+tgl_oleh+"',no_dokumen='"+no_dokumen+"',kd_brg='"+kd_brg+"',detail_brg='"+detail+"',kd_tanah='"+kd_tanah+"',nilai='"+nilai+"',asal='"+perolehan+"',dsr_peroleh='"+dsr_peroleh+"',total='"+nilai_baru+"',kondisi='"+kondisi+"',konstruksi='"+kontruksi+"',jenis='"+jenis+"',bangunan='"+bangunan+"',luas='"+luas+"',jumlah='"+jumlah+"',tgl_awal_kerja='"+tgl_awal+"',status_tanah='"+st_tanah+"',nilai_kontrak='"+nilai_kontrak+"',alamat1='"+alamat1+"',alamat2='"+alamat2+"',alamat3='"+alamat3+"',keterangan='"+keterangan+"',milik='"+milik+"',wilayah='"+wilayah+"',username='"+user+"',tgl_update='<?php echo date('y-m-d H:i:s');?>',tahun='"+tahun+"',foto='"+file_gbr1+"',foto2='"+file_gbr2+"',lat='"+clat+"',lon='"+clon+"' where id_barang ='"+id_barang+"'";// and no_urut='"+no_furut+"'
...
//		imageUrl:"<?php echo base_url();?>/lib/images/biak.jpg"
		...
		lcvalues = "('"+kd_riwayat+"','"+tgl_riwayat+"','"+detail_riwayat+"')";
            ...
            $(document).ready(function(){
                $.ajax({
                    type: "POST",
                    url: '<?php echo base_url(); ?>index.php/transaksi/simpan_trkib_f',
                    data: ({tabel:'trkib_f',no:id_barang,kolom:lcinsert,lcvalues:lcvalues}),
                    dataType:"json"
                });
            });    
        } else {
            lcquery = "update trkib_f set kd_riwayat='"+kd_riwayat+"',tgl_riwayat='"+tgl_riwayat+"',detail_riwayat='"+detail_riwayat+"' where id_barang ='"+id_barang+"' and tahun ='"+tahun+"' and kd_unit ='"+kd_unit+"' and kd_brg ='"+kd_brg+"'";//and no_urut ='"+no_urut+"' 
			$(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>index.php/transaksi/update_trkib_f',
     ...
     function hapus(){      
		...
		if(del==true){
        var urll = '<?php echo base_url(); ?>index.php/transaksi/hapus_trkib_f';
        $(document).ready(function(){
...
<div id="content1"> 
<div><h3 align="center"><b>.:INPUTAN MUTASI MASUK:.</br>.:INVENTARIS KONTRUKSI DALAM PEKERJAAN:.</b></h3></div>
<div align="center">
    <p>     
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING INVENTARIS KONTRUKSI DALAM PEKERJAAN" style="width:900px;height:310px;" >  
        </table>
		<table align="center" border="0" style="width:900px;height:35px; border-radius:5px 5px 5px 5px; background-color:#D0D0D0;">  
			<tr>
				...
				&nbsp;<a class="easyui-linkbutton" plain="true" onclick="javascript:kib_kib(5);"><b>[5] Aset Tetap Lainnya</b></a>							
				</td>
			</tr>
        </table>
        </td>
...
<div id="dialog-modal" title="">
    <p class="validateTips">.:Mutasi Masuk Kontruksi Dalam Pekerjaan</p> 
    <fieldset>
               ...
               <td width="50%" valign="top">
                    <table align="left" style="width:100%;" border="0">
                       <tr hidden="true">
                            <td>ID Barang</td>
                            <td>:</td>
                            <td><input id="id_barang" name="id_barang" style="width: 250px;" />
					  ...
					  <tr>
                            ...
                            <td width="5%">:</td>
                            <td width="70%"><input readonly="true" type="text" id="noreg" name="noreg" style="width:150px;" placeholder="Auto Number"/>
               ...
               <td width="50%" valign="top">
                    <table  align="left" style="width:100%;" border="0">
                       ...
                       <tr hidden="true">
                            ...
                            <td>:</td>
                            <td><input type="text" id="thn_anggar" name="thn_anggar" style="width:150px;" disabled ="true"/></td>
                       </tr>
                       <tr hidden="true">
