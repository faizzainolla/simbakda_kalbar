	...
	$('#tanggal').datebox({  
		...
		OnSelect: function(kode){
	     ...
	     $('#kib').combogrid({ 
            ...
            $('#dgkibmuta').edatagrid({url:'<?php echo base_url(); ?>index.php/transaksi/ambil_kib_muta_b',
	...
	*/
	...
	$('#uskpdb').combogrid({  
		...
		if(jenis_kib=='01'){
						$('#dgkibmuta').edatagrid({
					url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_muta_a',
					idField:'id',            
					rownumbers:"true", 
					fitColumns:"true",
					singleSelect:"true",
		...
		$('#dghmuta').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_muta_header_a',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
		  ...
		  edit_data();   
					...
					$('#dgkibmuta').edatagrid({
					url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_muta_b',
					idField:'id',            
					rownumbers:"true", 
					fitColumns:"true",
					singleSelect:"true",
	...
	$('#dghmuta').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_muta_header_b',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
		  ...
		  edit_data();   
					...
					$('#dgkibmuta').edatagrid({
					url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_muta_c',
					idField:'id',            
					rownumbers:"true", 
					fitColumns:"true",
					singleSelect:"true",
					...
					$('#dghmuta').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_muta_header_c',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
		  ...
		  edit_data();   
					...
					$('#dgkibmuta').edatagrid({
					url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_muta_d',
					idField:'id',            
					rownumbers:"true", 
					fitColumns:"true",
					singleSelect:"true",
...
$('#dghmuta').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_muta_header_d',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
		  ...
		  edit_data();   
					...
					$('#dgkibmuta').edatagrid({
					url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_muta_e',
					idField:'id',            
					rownumbers:"true", 
					fitColumns:"true",
					singleSelect:"true",
...
$('#dghmuta').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_muta_header_e',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
        ...
        onDblClickRow:function(rowIndex,rowData){
		  ...
		  edit_data();   
					...
					$('#dgkibmuta').edatagrid({
					url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_muta_f',
					idField:'id',            
					rownumbers:"true", 
					fitColumns:"true",
					singleSelect:"true",
		...
		$('#dghmuta').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_muta_header_f',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
   ...
   cekdouble=1;
    ...
    function simpan(){
        ...
        $('#dgkibmuta').datagrid;
					...
					{	if(jenis_kib=='01'){                    
                    lcquery = "UPDATE trkib_a SET no_mutasi='"+simnomts+"',tgl_mutasi='"+simtgl+"',kd_skpd_asal='"+simkdbaru+"',ket_mutasi='"+simket+"' where id_barang='"+simid+"'";
                    }else if(jenis_kib=='02'){                    
                    lcquery = "UPDATE trkib_b SET no_mutasi='"+simnomts+"',tgl_mutasi='"+simtgl+"',kd_skpd_asal='"+simkdbaru+"',ket_mutasi='"+simket+"' where id_barang='"+simid+"'";
                    }else if(jenis_kib=='03'){                    
                    lcquery = "UPDATE trkib_c SET no_mutasi='"+simnomts+"',tgl_mutasi='"+simtgl+"',kd_skpd_asal='"+simkdbaru+"',ket_mutasi='"+simket+"' where id_barang='"+simid+"'";
                    }else if(jenis_kib=='04'){                    
                    lcquery = "UPDATE trkib_d SET no_mutasi='"+simnomts+"',tgl_mutasi='"+simtgl+"',kd_skpd_asal='"+simkdbaru+"',ket_mutasi='"+simket+"' where id_barang='"+simid+"'";
                    }else if(jenis_kib=='05'){                    
                    lcquery = "UPDATE trkib_e SET no_mutasi='"+simnomts+"',tgl_mutasi='"+simtgl+"',kd_skpd_asal='"+simkdbaru+"',ket_mutasi='"+simket+"' where id_barang='"+simid+"'";
                    }else if(jenis_kib=='06'){                    
                    lcquery = "UPDATE trkib_f SET no_mutasi='"+simnomts+"',tgl_mutasi='"+simtgl+"',kd_skpd_asal='"+simkdbaru+"',ket_mutasi='"+simket+"' where id_barang='"+simid+"'";
                    }
...
function kosong(){
	...
	$('#nomts').attr('value','');	
		...
		if (del==true){
			...
			{
				if(jenis_kib=='01'){                    
                    lcquery = "UPDATE trkib_a SET no_mutasi=null,tgl_mutasi=null,kd_skpd_asal=null,ket_mutasi=null where id_barang='"+simid+"'";
                    }else if(jenis_kib=='02'){                    
                    lcquery = "UPDATE trkib_b SET no_mutasi=null,tgl_mutasi=null,kd_skpd_asal=null,ket_mutasi=null where id_barang='"+simid+"'";
                    }else if(jenis_kib=='03'){                    
                    lcquery = "UPDATE trkib_c SET no_mutasi=null,tgl_mutasi=null,kd_skpd_asal=null,ket_mutasi=null where id_barang='"+simid+"'";
                    }else if(jenis_kib=='04'){                    
                    lcquery = "UPDATE trkib_d SET no_mutasi=null,tgl_mutasi=null,kd_skpd_asal=null,ket_mutasi=null where id_barang='"+simid+"'";
                    }else if(jenis_kib=='05'){                    
                    lcquery = "UPDATE trkib_e SET no_mutasi=null,tgl_mutasi=null,kd_skpd_asal=null,ket_mutasi=null where id_barang='"+simid+"'";
                    }else if(jenis_kib=='06'){                    
                    lcquery = "UPDATE trkib_f SET no_mutasi=null,tgl_mutasi=null,kd_skpd_asal=null,ket_mutasi=null where id_barang='"+simid+"'";
                    }
			}
...
<div id="tabs" class="easyui-tabs">
    ...
    <div id="tabs-1">
<h1 align="center"><b>USULAN MUTASI KIB</b></h1>
	<div>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:tab2()">Tambah</a>
                ...
                <table  id="dghmuta" title="List Data Usulan Mutasi" style="width:940px;height:370px;" >  
                </table>                
                </div>
            </p>
        </div>
        ...
        <div id="tabs-2">
<h1 align="center"><b>MUTASI KIB</b></h1>
	<div>
            <p align="right">
                <!--<a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="javascript:tab2();">Tambah</a>
                <!--a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="javascript:hapus();">Hapus</a-->                           
    ...
    <fieldset>
          <table align="left" style="width:50%;" border="0">           		
			...
			<tr>
                <td>SKPD LAMA</td>
                <td>:</td>
                <td><input id="unit" disabled = true name="unit" style="width: 200px;border: 0;" readonly="true" value=""/>
                <!--td  hidden="true"><input type="text" id="thn2" style="width: 140px;" /></td-->
            </tr>
		   <tr>
                <td width="30%">SKPD BARU</td>
                <td width="1%">:</td>
                <td><input type="text" id="uskpdb" style="width:50px;"/></td>  
            </tr>
			<tr>
