...
<script type="text/javascript">
	...
	$('#bida').combogrid({  
            ...
            textField:'bidang',              
            mode:'remote',            
			url:'<?php echo base_url(); ?>index.php/master/load_bidang_mutasi_b',
  ...
  */   
   ...
   /*   $('#ruang').combogrid({  
	...
	$('#kd_riwayat').combogrid({  
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_b_mutasi_masuk',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
   ...
   function  cokot(foto,lc){
    ...
    function simpan(){
			...
			var kd_brg 		= $('#kdbrg').combogrid('getValue');//document.getElementById('kdbrg').value; //$('#kdbrg').combogrid('getValue');
      ...
      var kd_bidang = $('#bida').combogrid('getValue');//document.getElementById('kd_bidang').value;
	  var kd_asal = $('#skpdasal').combogrid('getValue');//document.getElementById('kd_bidang').value;
	  var kd_keg      = document.getElementById('nkd_keg').value;
        ...
        var nm_rek   = document.getElementById('nnm_rek5').value;
			...
			lcinsert = "(no_reg,id_barang,no,no_oleh,tgl_reg,tgl_oleh,no_dokumen,kd_golongan,kd_bidang,kd_brg,nm_brg,detail_brg,nilai,asal,dsr_peroleh,jumlah,total,merek,tipe,kd_warna,kd_bahan,kd_satuan,no_rangka,no_mesin,no_polisi,silinder,no_stnk,tgl_stnk,no_bpkb,tgl_bpkb,kondisi,keterangan,kd_ruang,kd_skpd,kd_unit,milik,wilayah,username,tgl_update,tahun,no_urut,metode,masa_manfaat,nilai_sisa,kd_pemilik,kd_kegiatan,nm_kegiatan,mutasi_masuk,kd_skpd_asal)";
        ...
        for(var i=0;i<jml;i++){
            ...
            if(i>0){
				...
				lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kd_gol+"','"+kd_bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilai+"','"+perolehan+"','"+dsr_peroleh+"','"+bagi+"','"+nilai_baru+"','"+merek+"','"+tipe+"','"+warna+"','"+bahan+"','"+satuan+"','"+norangka+"','"+nomesin+"','"+nopolisi+"','"+silinder+"','"+nostnk+"','"+tglstnk+"','"+nobpkb+"','"+tglbpkb+"','"+kondisi+"','"+keterangan+"','"+kd_ruang+"','"+skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+urutan+"','"+metode+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','1','"+kd_asal+"')";
				}else{
				//	lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kd_gol+"','"+kd_bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilai+"','"+perolehan+"','"+dsr_peroleh+"','"+bagi+"','"+nilai_baru+"','"+merek+"','"+tipe+"','"+warna+"','"+bahan+"','"+satuan+"','"+norangka+"','"+nomesin+"','"+nopolisi+"','"+silinder+"','"+nostnk+"','"+tglstnk+"','"+nobpkb+"','"+tglbpkb+"','"+kondisi+"','"+keterangan+"','"+kd_ruang+"','"+skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+file_gbr+"','"+file_gbr2+"','"+file_gbr3+"','"+file_gbr4+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
				lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+kd_gol+"','"+kd_bidang+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilai+"','"+perolehan+"','"+dsr_peroleh+"','"+bagi+"','"+nilai_baru+"','"+merek+"','"+tipe+"','"+warna+"','"+bahan+"','"+satuan+"','"+norangka+"','"+nomesin+"','"+nopolisi+"','"+silinder+"','"+nostnk+"','"+tglstnk+"','"+nobpkb+"','"+tglbpkb+"','"+kondisi+"','"+keterangan+"','"+kd_ruang+"','"+skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+username+"','"+tgl_update+"','"+tahun+"','"+urutan+"','"+metode+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','1','"+kd_asal+"')";
				}         
...
<div id="content1"> 
<div><h3 align="center"><b>.:INPUTAN MUTASI MASUK:.</BR> .:PERALATAN DAN MESIN:.</b></h3></div>
    <div align="center">
    <p>     
                    ...
                    <table align="left" style="width:100%;" border="0">
                       ...
                       <tr>
						...
						<tr>
                            ...
                            <td>Nama SKPD</td>
                            <td>:</td>
                            <td><input type="text" id="nmskpdasal" name='nmskpdasal' style="width:150px;"/></td>
                       </tr>
                       <tr>
