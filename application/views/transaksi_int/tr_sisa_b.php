    ...
    var lcstatus = '';
     ...
     $(function(){
        $('#dgkibb').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_b_sisa',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
		...
		$('#dgsisab').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_b_sisah',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
	...
	function tab1(){
    $('#tabs1').click();
	$('#dgsisab').edatagrid('reload');
    $("#txtcari").attr("setvalue",'');	
}
function tab2(){
   $('#tabs2').click()
   $('#dgkibb').edatagrid('reload');
   ...
   cekdouble=1;
    ...
    function simpan(){
        ...
        $('#dgkibb').datagrid('appendRow',{no_reg:simreg,id_barang:simid,nm_brg:simnm,kd_skpd:simkd,tahun:simthn,akum_penyu:simpenyu,nilai_sisa:simsisa});
					}else {
                    
                    lcquery = "UPDATE trkib_b SET akum_penyu='"+simpenyu+"',sisa_umur='"+simsisa+"' where id_barang='"+simid+"'";
...
function kosong(){
	...
	$('#sisaumur').attr('value','');	
		...
		if (del==true){
      lcquery = "UPDATE trkib_b SET akum_penyu=null ,sisa_umur=null where id_barang='"+simid+"'";
...
<div id="tabs" class="easyui-tabs">
    ...
    <div id="tabs-1">
<h1 align="center"><b>Inputan Akum Penyusutan dan Sisa Umur KIB B</b></h1>
	<div>
            <p align="right">
                ...
                <table  id="dgsisab" title="List Data Hasil Input Akumulasi Penyusutan dan Sisa Umur" style="width:940px;height:370px;" >  
                </table>                
                </div>
            </p>
        </div>
...
<h1 align="center"><b>Inputan Akum Penyusutan dan Sisa Umur KIB B</b></h1>
	<div>
            <p align="right">
                ...
                <input type="hidden" value="" id="txtnodok_h"/>
                <div title="Untuk Edit Data, Klik 2x Di Baris Yang Akan di Edit">              
                <table  id="dgkibb" title="List KIB B" style="width:940px;height:370px;" >  
                </table>                
                </div>
            </p>
        </div>
