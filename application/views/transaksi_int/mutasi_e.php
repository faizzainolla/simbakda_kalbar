        ...
        onSelect:function(rowIndex,rowData){
          // if (lcstatus == 'tambah'){
           ...
           $("#sta").attr("value",rowData.status.toUpperCase());
            ...
            textField:'bidang',              
            mode:'remote',            
			url:'<?php echo base_url(); ?>index.php/master/load_bidang_mutasi_e',
            loadMsg:"Tunggu Sebentar....!!",                                                 
            columns:[[  
...
$('#metode').combogrid({  
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/transaksi/ambil_kib_e_mutasi_masuk',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
lcinsert = "(no_reg,id_barang,no,no_oleh,tgl_reg,tgl_peroleh,no_dokumen,kd_golongan,kd_bidang,kd_brg,nm_brg,detail_brg,nilai,peroleh,dsr_peroleh,jumlah,total,judul,spesifikasi,asal,cipta,tahun_terbit,penerbit,kd_bahan,jenis,tipe,kd_satuan,kondisi,keterangan,kd_skpd,kd_unit,milik,wilayah,username,tgl_update,tahun,no_urut,metode,masa_manfaat,nilai_sisa,kd_pemilik,kd_kegiatan,nm_kegiatan,kd_rek5,nm_rek5,mutasi_masuk,kd_skpd_asal)";
	...
	//			lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+file_gbr3+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+lat+"','"+lon+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
				lcvalues = lcvalues+",('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"','1','"+kd_asal+"')";
			}else{
//				lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+file_gbr1+"','"+file_gbr2+"','"+file_gbr3+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+lat+"','"+lon+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"')";
				lcvalues = lcvalues+"('"+nomor+"','"+id_barang+"','"+no_gabung+"','"+no_oleh+"','"+tgl_reg+"','"+tgl_oleh+"','"+no_dokumen+"','"+gol+"','"+bida+"','"+kd_brg+"','"+nmbrg+"','"+detail+"','"+nilaisat+"','"+perolehan+"','"+dsr_peroleh+"','"+jum+"','"+nilai_baru+"','"+judul+"','"+spesifikasi+"','"+asal+"','"+pencipta+"','"+thn_terbit+"','"+penerbit+"','"+bahan+"','"+jenis+"','"+tipe+"','"+satuan+"','"+kondisi+"','"+keterangan+"','"+kd_skpd+"','"+kd_unit+"','"+milik+"','"+wilayah+"','"+user+"','<?php echo date('Y-m-d H:i:s'); ?>','"+tahun+"','"+urutan+"','"+metode+"','"+masa_manfaat+"','"+nilai_sisa+"','"+milik+"','"+kd_keg+"','"+nm_keg+"','"+kd_rek+"','"+nm_rek+"','1','"+kd_asal+"')";
			}              
...
<div id="content1"> 
<div><h3 align="center"><b>.:INPUTAN MUTASI MASUK:.</br>.:INVENTARIS ASET TETAP LAINNYA:.</b></h3></div>
<div align="center">
    <p>     
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING MUTASI MASUK ASET TETAP LAINNYA" style="width:900px;height:310px;" >  
        </table>
...
<div id="dialog-modal" title="">
    <p class="validateTips">.:Mutasi Masuk Aset Tetap Lainnya</p> 
    <fieldset>
            ...
            <tr>
              ...
              <td><input id="bida" name="bida"/>  </td>                            
                       ...
                       <tr>
                            ...
                            <td>:</td>
                            <td><input type="text" id="th_oleh" name="th_oleh" style="width:150px;" disabled ="true"/></td>
                       </tr>
                       <tr>
