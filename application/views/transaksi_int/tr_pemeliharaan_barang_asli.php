	...
	$('#kib').combogrid({  
            ...
            columns:[[
             ...
             onSelect:function(rowIndex,rowData){
                ...
                $('#pelihara').attr('value',rowData.pelihara);
				$('#kd_rek').attr('value',rowData.kd_rek_pelihara);
    		}  			
    });
...
function append_save(){
    ...
    function simpan_detail(){
        ...
        for(var i=0; i<rows.length; i++){
                ...
                if(i>0){
                    csql = csql+","+"('"+no_dokumen+"','"+no_kib+"','"+kd_skpd+"','"+kd_unit+"','"+idbrg+"','"+kd_golongan+"','"+nm_golongan+"','"+kd_bidang+"','"+nm_bidang+"','"+kd_brg+"','"+nm_brg+"','"+tahun+"','"+pelihara+"','"+kdrek+"','"+nilai+"','"+umur+"','"+uraian+"','"+ket+"','"+n_peli+"','"+n_oleh+"')";
                } else {
            ...
            $(document).ready(function(){
                $.ajax({
                    ...
                    dataType:'json', 
                    url: '<?php echo base_url(); ?>/index.php/transaksi/simpan_peliharabrg',   
                    data: ({tabel:'trd_trpelihara',no:no,sql:csql,uskpd:kd_skpd,lokasi:kd_unit,h_umur:umur,total:nilai,id_brg:idbrg,jns:kd_golongan,pl:pelihara}),
...
<div id="dialog-modal" title="Pilihan Kib" >
	...
	<table>
        ...
        <tr>
                ...
                <td>:<input type="text" id="cmbjenis" disabled=true name="cmbjenis" style="width: 200px;" />&nbsp;&nbsp;<input type="text" id="nmgolongan" name="nmgolongan" style="width: 200px;border: 0;" readonly="true"/></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>Bidang Barang</td>
                <td>:<input type="text" id="bidang" disabled=true name="bidang" style="width: 200px;" />&nbsp;&nbsp;<input type="text" id="nmbidang" name="nmbidang" style="width: 200px;border: 0;" readonly="true"/></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>Kode Barang</td>
                <td>:<input type="text" id="kdbarang" disabled=true name="kdbarang" style="width: 200px;" />&nbsp;&nbsp;<input type="text" id="nmkelompok" name="nmkelompok" style="width: 200px;border: 0;" readonly="true"/></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                <td>Tahun KIB</td>
                <td>:<input type="text" id="tahun" name="tahun" style="width: 140px;" /></td>
                <td></td>
                <td></td>
            </tr>
            <tr>
            <td>PILIH ASET</td>
            <td> :<input type="text" style="width: 140px;" ID="kib" NAME="kib" /><input type="hidden" id="id_brg" name="id_brg" style="width: 200px;"/></td>
		...
		<tr>
			...
			<td>:<INPUT ID="hrg" NAME="hrg" style="width: 140px;text-align: right;" onkeyup="hitung();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PERSENTASE : <input style="width: 60px;text-align: right;border:0;" ID="persen" NAME="persen" disabled="true"/>%</td>
			<td>PEN. MASA</td>
            <td>:</td>
