   ...
   $(function(){
     $('#dg').edatagrid({
        ...
        columns:[[
            ...
            {field:'header',title:'Header',width:10,align:"left",	editor:{type:'text',
					options:{ valueField:'header',
							  textField:'header',
							  panelwidth:910,	
							  panelheigth:20,	
							  required:true									  
            ...
            {field:'satuan',title:'Satuan',width:10,align:"center",	editor:{type:'text',
					options:{ valueField:'satuan',
							  textField:'satuan',
							  panelwidth:910,	
							  panelheigth:20,	
							  required:true									  
		...
		onAfterEdit:function(rowIndex, rowData, changes){	
				...
				simpan(kode,nama,header,satuan);
		}, 
    ...
    function kosong4(){
        $("#nm_subkel").attr("value",'');  
    }
    function kosong5(){
        $("#nm_subsubkel").attr("value",''); 
        $("#satuan").attr("value",'');  
        $("#spesifikasi").attr("value",'');  
    }
	
	function simpan(kode,nama,header,satuan){
		$(document).ready(function(){
			$.ajax({
				type: "POST",
				url: '<?php echo base_url(); ?>/index.php/bhp/simpan_bhp',
				data: ({kode:kode,nama:nama,header:header,satuan:satuan}),
				dataType:"json"
			});
		});                         
		$('#dg').datagrid('reload');        
...
function simpan_subsubkel(){
     ...
     function hapus(){
        //var kode 	= document.getElementById('kdwil').value;         
		var tny = confirm('Yakin Ingin Menghapus Data, Kode Barang : '+kode);   
        if (tny==true){
        var urll 	= '<?php echo base_url(); ?>index.php/master/hapus_master';
        $(document).ready(function(){
         $.post(urll,({tabel:'mbarang_hbs',cnid:kode,cid:'kode'}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
	...
	function max_gol_hbs(){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>index.php/master/max_gol_hbs',
            data: ({}),
            dataType:"json",
            success:function(data){                                          
                $.each(data,function(i,n){                                    
                    max_kode      = n['max_kode']; 
					nomorku		  = tambah_urut(max_kode,2);
                    $("#kd_gol").attr("value",nomorku );                           
                });
            }
        });         
    }
	...
	function max_bid_hbs(){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>index.php/master/max_bid_hbs',
            data: ({h:header}),
            dataType:"json",
            success:function(data){                                          
                $.each(data,function(i,n){                                    
	...
	function max_kel_hbs(){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>index.php/master/max_kel_hbs',
            data: ({h:header}),
            dataType:"json",
            success:function(data){                                          
                $.each(data,function(i,n){                                    
	...
	function max_subkel_hbs(){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>index.php/master/max_subkel_hbs',
            data: ({h:header}),
            dataType:"json",
            success:function(data){                                          
                $.each(data,function(i,n){                                    
	...
	function max_sub2_hbs(){
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo base_url(); ?>index.php/master/max_sub2_hbs',
            data: ({h:header}),
            dataType:"json",
            success:function(data){                                          
                $.each(data,function(i,n){                                    
                    max_kode    = n['kode']; 
					no	= tambah_urut(max_kode,4);
                    $("#kd_subsubkel").attr("value",no);                           
                });
            }
        });         
    }
    ...
    $(function(){
     $('#dg').edatagrid({
		url: '<?php echo base_url(); ?>index.php/bhp/load_brghbs',
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                ...
                <td width="1%">:</td>
                <td><input type="text" id="kd_gol" style="width:100px;" maxlength="2;"/></td>  
            </tr>        
            <tr>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                ...
                <td width="1%">:</td>
                <td><input type="text" id="gol" style="width:70px;" maxlength="2;"/>
				<input type="text" id="namagol" style="width:300px; border:0" readonly="true"/></td>  
            </tr>
            <tr>
                <td width="30%">KODE BIDANG</td>
                <td width="1%">:</td>
                <td><input type="text" id="kd_bid" style="width:100px;" maxlength="2;"/></td>  
            </tr>            
            <tr>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                ...
                <td width="1%">:</td>
                <td><input type="text" id="bag" style="width:70px;" maxlength="2;"/>
				<input type="text" id="namabag" style="width:300px; border:0" readonly="true"/></td>  
            </tr>
            <tr>
                <td width="30%">KODE KELOMPOK</td>
                <td width="1%">:</td>
                <td><input type="text" id="kd_kel" style="width:100px;" maxlength="2;"/></td>  
            </tr>            
            <tr>
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                <td width="30%">KODE KELOMPOK</td>
                <td width="1%">:</td>
                <td><input type="text" id="kel" style="width:70px;" maxlength="2;"/>
				<input type="text" id="namakel" style="width:300px; border:0" readonly="true"/></td>  
            </tr>
            <tr>
                <td width="30%">KODE SUB KELOMPOK</td>
                <td width="1%">:</td>
                <td><input type="text" id="kd_subkel" style="width:100px;" maxlength="2;"/></td>  
            </tr>        
            <tr>
...
<h2><a href="#" id="5" onclick="javascript:validate_combo()"><b>Kode Barang</b></a></h2>
<div id="5">
    <p class="validateTips">Semua Inputan Harus Di Isi.</p> 
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <tr>
                <td width="30%">KODE KELOMPOK</td>
                <td width="1%">:</td>
                <td><input type="text" id="subkel" style="width:70px;" maxlength="4;"/>
				<input type="text" id="namasubkel" style="width:300px; border:0" readonly="true"/></td>  
            </tr>
            <tr>
                <td width="30%">KODE BARANG</td>
                <td width="1%">:</td>
                <td><input type="text" id="kd_subsubkel" style="width:100px;" maxlength="4;"/></td>  
            </tr>            
            <tr>
