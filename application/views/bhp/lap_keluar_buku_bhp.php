	...
	function openWindow($cek){
		...
		var url	  		= "<?php echo site_url(); ?>/laporan_bhp/lap_buku_keluarbhp";
        if(cskpd==''){
            alert('Belum Pilih SKPD');
        }else if(ctgl==''){
            alert('Belum pilih Tanggal Cetak')
        }else{
        lc = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&tahu='+ctahu+'&bend='+cbend+'&tgl='+ctgl+'&giat='+cgiat+'&nmgiat='+cnmgiat+'&tgl_satu='+tgl_satu+'&tgl_dua='+tgl_dua+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>CETAK BUKU BARANG HABIS PAKAI KELUAR</b></h3>
    <fieldset>
