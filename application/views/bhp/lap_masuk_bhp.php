	...
	function openWindow($cek){
		...
		var url	  	= "<?php echo site_url(); ?>/laporan_bhp/lap_masukbhp";
        if(cskpd==''){
    ...
    $(function(){
		...
		$('#skpd').combogrid({  
           ...
           onSelect:function(rowIndex,rowData){
               lcskpda 	= rowData.kd_lokasi; 
               lcskpd = rowData.kd_skpd;
               $('#giat').combogrid({url:'<?php echo base_url(); ?>index.php/bhp/ambil_giat_keluar',queryParams:({skpd:lcskpd}) });
               $('#kdubidskpd').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_ubidskpd',queryParams:({kduskpd:lcskpda,skpd:lcskpd}) });
		...
		$('#kdubidskpd').combogrid({
           ...
           onSelect:function(rowIndex,rowData){
              ...
              // $('#kdubidskpd').combogrid({url:'<?php echo base_url(); ?>index.php/master/ambil_uskpd',queryParams:({kduskpd:lcskpd}) });
			   ...
			   if(ctk=='2'){
               $('#giat').combogrid({url:'<?php echo base_url(); ?>index.php/bhp/ambil_giat_keluar',queryParams:({skpd:lcskpd,uskpd:lcskpdx}) });
			   }
...
<div id="content1"> 
    <h3 align="center"><b>CETAK BARANG HABIS PAKAI MASUK</b></h3>
    <fieldset>
