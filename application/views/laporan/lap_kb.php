    ...
    function openWindow( url ){
        switch(ctk)
            ...
            default:
                ...
                var cbend = document.getElementById('nip_bend').value;
                var ctgl = $('#tgl_cetak').datebox('getValue');
                lc = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&nama_barang='+nama_barang+'&satuan='+satuan+'&spesifikasi='+spesifikasi+'&penyimpan='+penyimpan+'&bend='+cbend+'&tahu='+ctahu+'&tgl='+ctgl+'&cpilih=1';
				window.open(url+lc,'_blank');
                window.focus();
            }
...
<div id="content1"> 
    <h3 align="center"><b>KARTU BARANG</b></h3>
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            <!--tr>
                <td><input type="radio" name="cetak" value="1" onclick="opt(this.value)" />SKPD &ensp;</td>
                <!--="radio" name="cetak" value="2" id="status" onclick="opt(this.value)" />Per BIDANG &ensp;</td-->
            ...
            <tr>
                ...
                <div id="div_bend">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%">:</td>
                            <td><input id="penyimpan" name="penyimpan" style="width: 300px;" />
			...
			<tr>
                ...
                <div id="div_bend">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%">:</td>
                            <td><input id="nama_barang" name="nama_barang" style="width: 300px;" />
                            <input type="hidden" id="nip_bend"/> 
                            </td> 
                        </table>
                </div>
			...
			<tr>
                ...
                <div id="div_bend">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%">:</td>
                            <td><input id="satuan" name="satuan" style="width: 300px;" />
                            <input type="hidden" id="nip_bend"/> 
                            </td> 
                        </table>
                </div>
			...
			<tr>
                ...
                <div id="div_bend">
                        <table style="width:100%;" border="0">
                            ...
                            <td width="1%">:</td>
                            <td><input id="spesifikasi" name="spesifikasi" style="width: 300px;" />
                            <input type="hidden" id="nip_bend"/> 
                            </td> 
                        </table>
                </div>
            ...
            <tr>
                ...
                <a  href="<?php echo base_url(); ?>index.php/laporan/lap_kb" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
