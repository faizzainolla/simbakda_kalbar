	...
	function openWindow($cek){
		...
		iz = '?cbid='+cbid+'&kd_skpd='+cskpd+'&kd_bid='+cbidang+'&nm_skpd='+cnmskpd+'&cnm_bid='+cnm_bid+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&nmbend='+cnmbend+'&tgl_reg='+tgl_reg+'&nmtahu='+cnmtahu+'&tahun='+ctahun+'&tgl='+ctgl+'&pnilai='+pnilai+'&fa='+cpilih;
		...
		iz = '?cbid='+cbid+'&kd_skpd='+cskpd+'&kd_bid='+cbidang+'&nm_skpd='+cnmskpd+'&cnm_bid='+cnm_bid+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&tgl_reg='+tgl_reg+'&nmbend='+cnmbend+'&nmtahu='+cnmtahu+'&tahun='+ctahun+'&tgl='+ctgl+'&pnilai='+pnilai+'&fa='+cpilih;
		window.open(url+iz,'_blank');
		window.focus();
		}
		}
