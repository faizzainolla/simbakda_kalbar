<script type="text/javascript">
	...
	function openWindow($cek){
		...
		if(pnilai=='1'){
		var url			= "<?php echo site_url(); ?>/laporan/lap_buku_mutasi";
		}else{
		var url			= "<?php echo site_url(); ?>/laporan/lap_buku_mutasi_baru";
		}
		
		iz = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&kd_bid='+cbidang+'&nm_bid='+cnmbid+'&lctahu='+lctahu+'&lcbend='+lcbend+'&cnmbend='+cnmbend+'&cnmtahu='+cnmtahu+'&lctgl2='+lctgl2+'&tgl_awal='+tgl_awal+'&tgl_akhir='+tgl_akhir+'&fa='+cpilih;
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <div id="div_awal">
                        <table style="width:100%;" border="0">
                            <td width="20%">PER TANGGAL AWAL</td>
                            <td width="1%">:</td>
                            <td><input type="text" id="tgl_awal" style="width: 140px;" />
                            </td> 
                        </table>
                </div>
                </td> 
            ...
            <tr>
                ...
                <div id="div_akhir">
                        <table style="width:100%;" border="0">
                            <td width="20%">PER TANGGAL AKHIR</td>
                            <td width="1%">:</td>
