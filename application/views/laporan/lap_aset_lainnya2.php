	...
	if (ctk==2){
		...
		var url			= "<?php echo site_url(); ?>/laporan/lap_aset_lainnya2";

		/* if (cpilih == '3'){				
		var url			= "<?php echo site_url(); ?>/laporan/lap_aset_lainnya2x";
		}else if(tgl_reg == ''){
		...
		iz = '?cbid='+cbid+'&kd_skpd='+cskpd+'&kd_bid='+cbidang+'&nm_skpd='+cnmskpd+'&cnm_bid='+cnm_bid+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&tahun='+ctahun+'&jenis='+cjenis+'&tgl_reg='+tgl_reg+'&tgl='+ctgl+'&pnilai='+pnilai+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>CETAK LAPORAN ASET LAINNYA<br>
