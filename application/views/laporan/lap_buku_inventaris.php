    ...
    function openWindow( url ){
        ...
        lc = '?kd_skpd='+cskpd+'&nm_skpd='+cnmskpd+'&tahu='+ctahu+'&bend='+cbend+'&tgl='+ctgl+'&tahun='+cthn;
...
<div id="content1"> 
    <h3 align="center"><b>LAPORAN BUKU INVENTARIS</b></h3>
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <a  href="<?php echo base_url(); ?>index.php/laporan/lap_buku_inventaris" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Format 1</a>
                <a  href="<?php echo base_url(); ?>index.php/laporan/lap_buku_inventaris2" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Format 2</a>				
