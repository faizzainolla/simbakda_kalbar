...
<div id="content1"> 
    <h3 align="center"><b>LAPORAN SEMESTERAN BARANG PAKAI HABIS<br>
    TAHUN ANGGARAN</b></h3>
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                ...
                <a  href="<?php echo base_url(); ?>index.php/laporan/lap_sbph" class="easyui-linkbutton" iconCls="icon-print" plain="true" onclick="javascript:openWindow(this.href);return false">Cetak</a>
