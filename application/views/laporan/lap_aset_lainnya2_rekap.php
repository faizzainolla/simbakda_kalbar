	...
	function openWindow($cek){
		...
		var url			= "<?php echo site_url(); ?>/laporan/lap_lainnya_rekap";
		if(oto=='01'){
			if(ctgl == ''){
		...
		iz = '?cbid='+cbid+'&kd_skpd='+cskpd+'&kd_bid='+cbidang+'&nm_skpd='+cnmskpd+'&cnm_bid='+cnm_bid+'&nm_bid='+cnmbid+'&bend='+cbend+'&tahu='+ctahu+'&nmbend='+cnmbend+'&nmtahu='+cnmtahu+'&tgl_reg='+tgl_reg+'&tahun='+ctahun+'&tgl='+ctgl+'&pnilai='+pnilai+'&fa='+cpilih;
...
<div id="content1"> 
    <h3 align="center"><b>CETAK REKAP ASET LAINNYA</b></h3>
    <fieldset>
