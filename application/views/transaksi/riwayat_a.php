...
<script type="text/javascript">
    ...
    var no_urut=0;
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url();?>index.php/transaksi/riwayat_kib_a',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
<div id="content1"> 
<div><h3 align="center"><b>.:INPUTAN RIWAYAT INVENTARIS TANAH:.</b></h3></div>
    <div align="center">
    <p>     
...
<div id="dialog-modal" title="">
    <p class="validateTips">.:Tambah Riwayat Tanah</p>
    <fieldset>
