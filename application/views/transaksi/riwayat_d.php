...
<script type="text/javascript">
    ...
    var no_urut=0;
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url();?>index.php/transaksi/riwayat_kib_d',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
   ...
   function get1(id_barang,tgl_riwayat,kd_riwayat,detail_riwayat,kd_skpd,nilai,tahun,kd_unit,no_urut,kd_brg){
    ...
    function simpan(){
		...
		lcvalues = "('"+kd_riwayat+"','"+tgl_riwayat+"','"+detail_riwayat+"')";
            ...
            lcquery = "update trkib_d set kd_riwayat='"+kd_riwayat+"',tgl_riwayat='"+tgl_riwayat+"',detail_riwayat='"+detail_riwayat+"' where id_barang ='"+id_barang+"' and tahun ='"+tahun+"' and no_urut ='"+no_urut+"' and kd_unit ='"+kd_unit+"' and kd_brg ='"+kd_brg+"'";
			$(document).ready(function(){
            $.ajax({
                type: "POST",
...
<div id="content1"> 
<div><h3 align="center"><b>.:INPUTAN RIWAYAT INVENTARIS JALAN DAN IRIGASI:.</b></h3></div>
    <div align="center">
    <p>     
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING INVENTARIS JALAN DAN IRIGASI" style="width:900px;height:365px;">  
        </table>
        </td>
        </tr>
    </table>    
...
<div id="dialog-modal" title="">
    <p class="validateTips">.:Tambah Riwayat Jalan Dan Irigasi</p>
    <fieldset>
