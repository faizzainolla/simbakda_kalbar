 <script type="text/javascript">
    ...
    var lpdok = '';var no_urut=0;
     ...
     $('#dg').edatagrid({
        ...
        $('#kib').combogrid({  
            ...
            textField:'kd_brg',              
            mode:'remote',            
			url:'<?php echo base_url(); ?>index.php/transaksi/ambil_kib_c_k',
            loadMsg:"Tunggu Sebentar....!!",                                                 
            columns:[[  
               ...
               {field:'luas_lantai',title:'Luas Gedung',width:80,align:"center"},
	...
	function load_kib(id_brg){
        ...
        $('#trd').edatagrid({
            ...
            queryParams:({tabel:'trkib_c_kap',tabel2:'trkib_c',gol:ngol}),
            rownumbers:true, 
            fitColumns:false,
            singleSelect:false,
			pagination:"true",
    ...
    function simpan(){
     ...
     function hapus_detail(){
        ...
        $(document).ready(function(){
         $.post(urll,({tabel:'trkib_c_kap',cid:'nilai',cnid:nilai,kolom:'kd_skpd',unit:kd_skpd}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
