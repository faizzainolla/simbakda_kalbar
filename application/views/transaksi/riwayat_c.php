...
<script type="text/javascript">
    ...
    var no_urut=0;
     ...
     $('#dg').edatagrid({
		url: '<?php echo base_url();?>index.php/transaksi/riwayat_kib_c',
        idField:'id',            
        rownumbers:"true", 
        fitColumns:"true",
        singleSelect:"true",
...
<div id="content1"> 
<div><h3 align="center"><b>.:INPUTAN RIWAYAT INVENTARIS GEDUNG DAN BANGUNAN:.</b></h3></div>
    <div align="center">
    <p>     
    <table style="width:400px;" border="0">
        ...
        <tr>
        <td colspan="4">
        <table id="dg" align="center" title="LISTING INVENTARIS GEDUNG DAN BANGUNAN" style="width:900px;height:365px;">  
        </table>
        </td>
        </tr>
    </table>    
...
<div id="dialog-modal" title="">
    <p class="validateTips">.:Tambah Riwayat Gedung Dan Bangunan</p>
    <fieldset>
