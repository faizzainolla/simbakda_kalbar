 <script type="text/javascript">
    ...
    var lpdok = '';var no_urut=0;
     ...
     $('#dg').edatagrid({
        ...
        $('#kib').combogrid({  
            ...
            textField:'kd_brg',              
            mode:'remote',            
			url:'<?php echo base_url(); ?>index.php/transaksi/ambil_kib_a_k',
            loadMsg:"Tunggu Sebentar....!!",                                                 
            columns:[[  
	...
	function load_kib(id_brg){
        ...
        $('#trd').edatagrid({
            ...
            queryParams:({tabel:'trkib_a_kap',tabel2:'trkib_a',gol:ngol}),
            rownumbers:true, 
            fitColumns:false,
            singleSelect:false,
			pagination:"true",
    ...
    function simpan(){
        ...
        lcinsert = '(no_reg,id_barang,no,tgl_reg,no_dokumen,kd_brg,nilai,total,keterangan,kd_skpd,kd_unit,tahun,tgl_perolehan,hrg_perolehan)';
        if (tahun_kap==''){
		...
		lcvalues = "('"+no_reg+"','"+id_barang+"','"+no+"','"+tgl_kdp+"','"+no_kap+"','"+kd_brg+"','"+tmbh_manfaat+"','"+tmbh_manfaat+"','"+keterangan+"','"+skpd+"','"+kd_unit+"','"+tahun_kap+"','"+tgl_perolehan+"','"+peroleh+"')";
           ...
           $(document).ready(function(){
                $.ajax({
                    ...
                    data: ({tabel:'trkib_a_kap',tabel2:'trkib_a',no:no_dokumen,lkd_brg:kd_brg,kolom:lcinsert,lcvalues:lcvalues,id_barang:id_barang,kib_kdp:kib_kdp,tgl_kdp:tgl_kdp,id_kdp:id_kdp}),
                    dataType:"json"
                });
            });  
			load_kib(id_barang);	
     ...
     function hapus_detail(){
        ...
        $(document).ready(function(){
         $.post(urll,({tabel:'trkib_a_kap',cid:'nilai',cnid:nilai,kolom:'kd_skpd',unit:kd_skpd}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
