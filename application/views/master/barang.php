    ...
    $(function(){ 
     $('#dg').edatagrid({
       ...
       function simpan_tetap(){
        ...
        var lntotal = delCommas(document.getElementById('nilai').value);
...
//        });
        ...
        $('#dg').datagrid('appendRow',{no_tetap:cno,tgl_tetap:ctgl,kd_skpd:cskpd,kd_rek5:lckdrek,nilai:lntotal,keterangan:lcket});
        } else {
            
            lcquery = "UPDATE tr_tetap SET tgl_tetap='"+ctgl+"',kd_skpd='"+cskpd+"',kd_rek5='"+lckdrek+"',nilai="+
                       lntotal+",keterangan='"+lcket+"' where no_tetap='"+cno+"'";
            
            //alert(lcquery);
            $(document).ready(function(){
            $.ajax({
                type: "POST",
                url: '<?php echo base_url(); ?>index.php/tukd/update_tetap',
     ...
     function hapus(){
        ...
        $(document).ready(function(){
         $.post(urll,({no:cnomor,skpd:cskpd}),function(data){
            status = data;
            if (status=='0'){
                alert('Gagal Hapus..!!');
                exit();
    ...
    <fieldset>
     <table align="center" style="width:100%;" border="0">
            ...
            <tr>
                <td>Rekening</td>
                <td></td>
                <td><input id="rek" name="rek" style="width: 140px;" />  <input type="text" id="nmrek" style="border:0;width: 600px;" readonly="true"/></td>                
            </tr>            
            <tr>
                <td>Nilai</td>
                <td></td>
                <td><input type="text" id="nilai" style="width: 200px;"/></td> 
            </tr>
            <tr>
                <td>Keterangan</td>
